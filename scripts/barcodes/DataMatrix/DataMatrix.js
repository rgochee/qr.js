define(function (require) {
	...
	var DataMatrixCreator = {
		...
		setSize: function(width, height) {
			...
			if (width != height) {
				if (width == 8) {
					if (height != 18 || height != 32) {
						return false;
					}
				} else if (width == 12) {
					if (height != 26 || height != 36) {
						return false;
					}
				} else if (width == 16) {
		...
		clearQuietZone: function() {
			MatrixBarcode.drawRect(0, 0, 1, this.getWidth()+2, false);
			MatrixBarcode.drawRect(this.getWidth()+1, 0, 1, this.getWidth()+2, false);
			MatrixBarcode.drawRect(1, 0, this.getWidth()+1, 1, false);
			MatrixBarcode.drawRect(1, this.getWidth()+1, this.getWidth()+1, 1, false);
		},
		...
		initGrid: function() {
			//MatrixBarcode.initGrid(this.getWidth()+2);
